package com.yi.ai.sparkproject.test;
...
public class JDBCHelperTest {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * paramsList.add(new Object[] { "麻子", 30 }); paramsList.add(new
		 * Object[] { "王五", 35 });
		 * 
		...
		// 并将查询结果，放入外部的变量中
		jdbcHelper.executeQuery("select name,age from test_user where age=?", new Object[] { 28 },
