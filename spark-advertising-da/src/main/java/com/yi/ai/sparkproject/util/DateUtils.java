package com.yi.ai.sparkproject.util;
...
public class DateUtils {
	 ...
	 * @return 差值
	 */
	public static int minus(Date time1, Date time2) {
		try {
			/*
			 * Date datetime1 = TIME_FORMAT.parse(time1); Date datetime2 =
			 * TIME_FORMAT.parse(time2);
			 */
